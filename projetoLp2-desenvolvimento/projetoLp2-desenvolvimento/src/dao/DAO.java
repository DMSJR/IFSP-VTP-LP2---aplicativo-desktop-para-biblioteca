...
public class DAO {
	...
	private static String CONSULTAR_USUARIO = " SELECT NOME, SENHA  " + " FROM USUARIOS " + " WHERE NOME = ? "
			+ " AND SENHA = ? ";
	...
	private static String ALTERAR_LIVRO = "UPDATE LIVRO SET "
			+ " TITULO = ?, AUTOR = ?, ANO = ?, EDITORA = ?, ISBN = ?, IDLOCARIO = ? "+ "WHERE IDLIVRO = ? ";
	...
	private static String CADASTRAR_USUARIO = " INSERT INTO USUARIOS  "
			+ " (ID, NOME, SENHA) " + " VALUES (NULL, ?, ?) ";
	public DAO() {
